...
namespace EA.NetDevPack.TypeSearchers
{
    /// <summary>
    ...
    public class TypeSearcher : ITypeSearcher
    {
        ...
        /// <returns>A list of assemblies that should be loaded by the EA.NetDevPack factory.</returns>
        ...
        private IList<Assembly> AssembliesInAppDomain()
        {
            ...
            foreach (Assembly assembly in AppDomain.CurrentDomain.GetAssemblies())
            {
                ...
                if (referencedAssemblies.Where(x => x.FullName == currentAssem.FullName).Any()
                    || product?.Product == "EA.NetDevPacknode")
                {
