...
using EA.NetDevPack.SharedKernel.Extensions;
...
namespace EA.NetDevPack.Plugins
{
    /// <summary>
    /// Plugin manager
    /// </summary>
    public static class PluginManager
    {
            ...
            Assembly assembly, string systemName, string filename)
        {
            ...
            {
                Log.Error(ex, "PluginManager");
                throw new InvalidOperationException($"The plugin directory for the {systemName} file exists in a folder outside of the allowed EA.NetDevPacknode folder hierarchy - exception because of {filename} - exception: {ex.Message}");
            }
        }
